...
class GeneralKnowledgeQuizSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $medium = Category::firstOrCreate(['name' => 'Medium', 'quiz_id' => $quiz->id]);
        $hard = Category::firstOrCreate(['name' => 'Hard', 'quiz_id' => $quiz->id]);
